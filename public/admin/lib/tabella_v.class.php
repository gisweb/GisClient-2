...
//if($this->error_flag==1)
	...
	$nrighe=$this->num_col;
	$tabella="<table cellPadding=\"2\" border=\"0\" class=\"stiletabella\" width=\"90%\">\n";
	...
	for ($i=0;$i<$nrighe;$i++){
		...
		if ($riga[0]=="")
			...
			$tabella.="\t\t<td width=\"200px\" bgColor=\"".$this->sfondo_label."\"><font color=\"".$this->testo_label."\"><b>$riga[0]</b></font></td>\n";
