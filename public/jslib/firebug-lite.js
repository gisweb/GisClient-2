var firebug = {
    version:[1.21,200809],
    el:{}, env:{ "cache":{}, "css":"css/firebug-lite.css", "dIndex":"console", "height":295, "init":false, "minimized":false, "ml":false },
    init:function(_css){
        with(firebug){
        ...
        console:{
            ...
            cmd:{
                ...
                trace: function(_value){
                    with(firebug){
                        var stackAmt = 3, f = arguments.caller;
                        if(f){
                            try {
                    ...
                    if(_value.nodeType==3)
                        ...
                        if(_inArray){
                            ...
                            if(_value.getAttribute){
                                ...
                                var elClass = _value.getAttribute(lib.env.ie6||lib.env.ie7?"className":"class")||"";
