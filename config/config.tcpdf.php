...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 */
	define ("K_PATH_MAIN", ROOT_PATH."public/");
	
	/**
	 * url path (http://localhost/tcpdf/)
	 */
	define ("K_PATH_URL", "http://gwserver/gisclient/");
	
	/**
	 * path for PDF fonts
	 * use K_PATH_MAIN."fonts/old/" for old non-UTF8 fonts
	 */
	define ("K_PATH_FONTS", "/apps/includes/tcpdf/fonts/");
	
	/**
	 * cache directory for temporary files (full path)
	 */
	define ("K_PATH_CACHE", "/tmp/ms_tmp");
	
	/**
	 * cache directory for temporary files (url path)
	 */
	define ("K_PATH_URL_CACHE", "/tmp/ms_tmp");
